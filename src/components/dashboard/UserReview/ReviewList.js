 ...
 import { getRandomColors } from '../../tools/colours';
 import Button from '../../tools/Button';
 import { CheckIcon, RefreshIcon, TrashIcon } from '../../tools/Icon';
         ...
         <div key={index} className='review-box'>
           <div className='mb-3 p-4'>
             ...
             <div className='d-flex flex-column flex-lg-row mx-0 mb-3 align-items-start justify-content-between'>
               <div className='w-100 mb-3 mb-lg-0 review-provider-box'>
                 <Link
                   to={`/provider/${review.provider.slug}`}
